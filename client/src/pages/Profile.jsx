    ...
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <img
          ...
          alt="profile"
          className='rounded-full h-24 w-24 object-cover cursor-poniter self-center mt-2'
        />
        ...
        <div className='flex flex-col gap-4'>
          ...
          {userListings.map((listing) => (
            ...
            >
              ...
              <Link className='flex-1 text-slate-700 font-semibold hover:underline' to={`/listing/${listing._id}`}>
                <p>{listing.name}</p>
              </Link>
